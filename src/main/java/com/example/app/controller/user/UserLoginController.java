	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) {
		...
		try {
			...
			try {
				...
				System.out.println("session 값 : " + session.getAttribute("session"));
				System.out.println("name 값 :" + session.getAttribute("name"));
				System.out.println("sessionId 값 : " + session.getAttribute("sessionId"));
				}
