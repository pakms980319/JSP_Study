...
public class ItemBusinessManSearch implements SubController {

	ConnectionPool_ByHikari connectionPool;
	ItemService service;

	public ItemBusinessManSearch() {
		try {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) {
		System.out.println("ItemBusinessManSearch execute : ");
		System.out.println("");
		...
		System.out.println("ItemBusinessManSearch execute  type : " + type);
		System.out.println("ItemBusinessManSearch execute  keyword : " + keyword);
		...
		//유효성
		//서비스
		System.out.println("ItemBusinessManSearch execute criteria : " + criteria);
		Map<String,Object> returnValue = null;
		
		try {
			returnValue = service.getAllBusinessManItems(criteria, userId);			
		...
		System.out.println("ItemBusinessManSearch execute list : " + list);
		System.out.println("ItemBusinessManSearch execute pageDto : " + pageDto);


		System.out.println("");
		try {
			
			req.getRequestDispatcher("/WEB-INF/view/item/businessManSearch.jsp").forward(req, resp);
