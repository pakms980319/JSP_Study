					...
					<table class="table">
						...
						<c:forEach var="itemDto" items="${list}" varStatus="status">
							<tr>
								...
								<td><a
									href="${pageContext.request.contextPath}/item/read?itemId=${itemDto.itemId}">
										<c:out value="${itemDto.itemId}" />
								</a></td>
					...
					<nav aria-label="Page navigation example">
						<ul class="pagination">
							...
							<c:if test="${pageDto.next}">
								<li class="page-item"><a class="page-link"
									href="${pageContext.request.contextPath}/book/list?pageNo=${pageDto.nowBlock*pageDto.pagePerBlock+1}&type=${pageDto.criteria.type}&keyword=${pageDto.criteria.keyword}"
